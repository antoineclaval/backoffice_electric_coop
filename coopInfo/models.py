...
class Cooperative(models.Model):
    ...
    consumers = models.IntegerField(default=0, null=True)
    montlyMeeting = models.CharField(max_length=20)
    annualMeeting = models.CharField(max_length=20)
    numberOfEmployees = models.IntegerField(default=0, null=True)
    milesOfLines = models.IntegerField(default=0, null=True)
